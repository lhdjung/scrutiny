...
pigs1_exp <- tibble::tibble(
  ...
  n = c(
    25L, 25L, 25L, 25L, 25L, 25L, 25L, 25L, 25L, 25L, 29L, 29L,
    29L, 29L, 29L, 29L, 29L, 29L, 29L, 29L, 24L, 24L, 24L, 24L, 24L,
    24L, 24L, 24L, 24L, 24L, 27L, 27L, 27L, 27L, 27L, 27L, 27L, 27L,
    27L, 27L, 29L, 29L, 29L, 29L, 29L, 29L, 29L, 29L, 29L, 29L, 27L,
    27L, 27L, 27L, 27L, 27L, 27L, 27L, 27L, 27L, 31L, 31L, 31L, 31L,
    31L, 31L, 31L, 31L, 31L, 31L, 28L, 28L, 28L, 28L, 28L, 28L, 28L,
    28L, 28L, 28L, 20L, 21L, 22L, 23L, 24L, 26L, 27L, 28L, 29L, 30L,
    24L, 25L, 26L, 27L, 28L, 30L, 31L, 32L, 33L, 34L, 19L, 20L, 21L,
    22L, 23L, 25L, 26L, 27L, 28L, 29L, 22L, 23L, 24L, 25L, 26L, 28L,
    29L, 30L, 31L, 32L, 24L, 25L, 26L, 27L, 28L, 30L, 31L, 32L, 33L,
    34L, 22L, 23L, 24L, 25L, 26L, 28L, 29L, 30L, 31L, 32L, 26L, 27L,
    28L, 29L, 30L, 32L, 33L, 34L, 35L, 36L, 23L, 24L, 25L, 26L, 27L,
    29L, 30L, 31L, 32L, 33L
  ),
  consistency = c(
...
pigs2_exp <- tibble::tibble(
  ...
  n = c(
    150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L,
    150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L,
    150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L,
    150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L, 150L,
    150L, 150L, 150L, 150L, 150L, 150L, 150L, 145L, 146L, 147L, 148L,
    149L, 151L, 152L, 153L, 154L, 155L, 145L, 146L, 147L, 148L, 149L,
    151L, 152L, 153L, 154L, 155L, 145L, 146L, 147L, 148L, 149L, 151L,
    152L, 153L, 154L, 155L, 145L, 146L, 147L, 148L, 149L, 151L, 152L,
    153L, 154L, 155L, 145L, 146L, 147L, 148L, 149L, 151L, 152L, 153L,
    154L, 155L
  ),
  consistency = rep(
    c(
...
pigs1_include_reported_exp <- tibble::tibble(
  ...
  n = c(
    ...
    24L, 24L, 24L, 24L, 24L, 24L, 24L, 24L, 27L, 27L, 27L, 27L, 27L,
    27L, 27L, 27L, 27L, 27L, 27L, 29L, 29L, 29L, 29L, 29L, 29L, 29L,
    29L, 29L, 29L, 29L, 27L, 27L, 27L, 27L, 27L, 27L, 27L, 27L, 27L,
    27L, 27L, 31L, 31L, 31L, 31L, 31L, 31L, 31L, 31L, 31L, 31L, 31L,
    28L, 28L, 28L, 28L, 28L, 28L, 28L, 28L, 28L, 28L, 28L, 20L, 21L,
    22L, 23L, 24L, 25L, 26L, 27L, 28L, 29L, 30L, 24L, 25L, 26L, 27L,
    28L, 29L, 30L, 31L, 32L, 33L, 34L, 19L, 20L, 21L, 22L, 23L, 24L,
    25L, 26L, 27L, 28L, 29L, 22L, 23L, 24L, 25L, 26L, 27L, 28L, 29L,
    30L, 31L, 32L, 24L, 25L, 26L, 27L, 28L, 29L, 30L, 31L, 32L, 33L,
    34L, 22L, 23L, 24L, 25L, 26L, 27L, 28L, 29L, 30L, 31L, 32L, 26L,
    27L, 28L, 29L, 30L, 31L, 32L, 33L, 34L, 35L, 36L, 23L, 24L, 25L,
    26L, 27L, 28L, 29L, 30L, 31L, 32L, 33L
  ),
  consistency = rep(
    rep(c(FALSE, TRUE), 40),
    c(
      3L, 1L, 3L, 1L, 6L, 1L, 2L, 1L, 3L, 1L, 2L, 1L, 3L, 1L, 3L,
      1L, 2L, 1L, 3L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 5L, 1L, 3L,
      1L, 3L, 2L, 2L, 1L, 2L, 1L, 3L, 1L, 2L, 1L, 3L, 1L, 3L, 1L, 3L,
      1L, 3L, 1L, 5L, 1L, 3L, 2L, 5L, 1L, 1L, 1L, 4L, 1L, 1L, 1L, 3L,
      1L, 3L, 2L, 12L, 1L, 5L, 2L, 4L, 2L, 6L, 2L, 2L, 1L, 3L, 1L,
      3L, 1L
    )
  ),
  ratio = c(
