...
Large parts of the package ultimately rest on either of two functions that simply count decimal places. These are characters after a number's decimal point or some other separator. Both functions also take strings.
