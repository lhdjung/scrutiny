...
Leading and trailing `NA`s are ignored when determining whether `x` *might* be a linear sequence (or other kind of sequence). They do prevent the functions from returning `TRUE`, but they don't require the non-missing values to be in any particular order:
