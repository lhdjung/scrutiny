...
```{r}
out_seq2 <- grimmer_map_seq(pigs5, digits_x = 2, digits_sd = 2, dispersion = 1:10)
audit_seq(out_seq2)
```
...
```{r, fig.width=6, fig.height=5.5}
out_seq1_only_x <- grimmer_map_seq(pigs5, digits_x = 2, digits_sd = 2, var = "x")
out_seq1_only_n <- grimmer_map_seq(pigs5, digits_x = 2, digits_sd = 2, var = "n")
