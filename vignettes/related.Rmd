...
-   Several R packages leverage the Benford distribution of naturally occurring numbers to assess whether reported numbers are, in fact, natural. The packages include:
...
-   Emerging from the Pruitt investigations, the R package [twopointzerothree](https://github.com/Sorbus-torminalis/twopointzerothree/) (by an anonymous developer) checks data for sequences of perfectly correlated numbers, pointing out cases where each number is identical to its predecessor plus some constant amount.
