...
-   The R package [validate](https://cran.r-project.org/web/packages/validate/vignettes/cookbook.html) by Mark P.J. van der Loo provides numerous tools for data checking.
