...
-   [ScrutiPy](https://github.com/nrposner/scrutipy) by Nicolas Roman Posner provides a Python interface to some of scrutiny's functionality. It also features CLOSURE and is mostly implemented in Rust.
...
-   [tidychain](https://usrbinr.codeberg.page/tidychain/) by Alejandro Hagan is an R package for "calcChain" Excel analysis, as it was used by Data Colada's investigation into the work of Francesca Gino.
