...
Set `show_rec` to `TRUE` if you want the intermediate reconstructed values from GRIM-testing to be displayed in the output. They will be columns prefixed with `rec_`:
