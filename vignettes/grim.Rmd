...
Both functions are vectorized, like `grim()`. Because a reported mean can stand for any number of achievable ones, `grim_values()` returns a list, with one element per value set --- which makes it easy to add as a list-column:
