...
This vignette generated five example functions, four of them via function factories. Three of these factories are part of scrutiny's infrastructure. Starting with a simple mock test, an entire family of functions sprung up to apply that test in special cases, with a unified API, and at any scale --- all with just a few lines of easy to write code.
...
# Note: The bold margins were created by (1) selecting the respective field, (2) clicking on the View symbol at the upper left, (3) selecting "Format Panel", and (4) setting the line thickness from 1 to 3 pt.
```
