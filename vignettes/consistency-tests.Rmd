...
# NOTE: The two diagrams below should have width 585 and height 456 (the latter automatically, via a locked aspect ratio).
```
...
![](images/consistency_test_columns_output.png){width="585"}
