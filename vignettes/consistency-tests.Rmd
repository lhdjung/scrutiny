...
Key columns may or may not be modified by transformer columns and/or by arguments.
...
If your handwritten function creates new columns beyond `"consistency"`, you'll have to remove them from the output first. Don't use transformer columns when testing because `function_map()` can't handle them.
