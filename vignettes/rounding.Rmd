...
However, if the raw values are preliminarily rounded to 2 decimal places before rounding occurs as above, the picture is different. This might be relevant for RIVETS, an error detection technique yet to be formalized. I will spare you the code this time:
