...
Sometimes `round()` behaves just as it should, but at other times, results can be hard to explain. [Martin Mächler](https://cran.r-project.org/web/packages/round/vignettes/Rounding.html), who wrote the present version of `round()`, describes the issue about as follows:
