...
See the GRIM vignette for a [more comprehensive case study](https://lhdjung.github.io/scrutiny/articles/grim.html#handling-unknown-group-sizes-with-grim_map_total_n). It uses `grim_map_total_n()`, which is the same as `debit_map_total_n()` but only for GRIM.
