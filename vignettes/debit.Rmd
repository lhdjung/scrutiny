...
## Visualize results with `debit_plot()`
...
[TO DO: Heathers noted [on Twitter](https://twitter.com/jamesheathers/status/1145663498376089606): "The little boxes are due to rounding - they're thin when there's no rounding, they're fat when there is." So that's my answer to the question about the difference between fat and thin boxes in the DEBIT paper --- it's just based on assumptions about those values having been rounded or not. So, I need to implement this in `debit()`, `debit_map()`, and `debit_plot()`!]
