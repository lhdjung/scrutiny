...
```{r, echo=FALSE}
# Determine ggplot2 theme for the entire document:
ggplot2::theme_minimal(base_size = 12) %>% 
  ggplot2::theme_set()
```
...
Here is how to GRIM-test all values in a data frame. `consistency` tells you if the means (`x`) and sample sizes (`n`) are mutually consistent.
